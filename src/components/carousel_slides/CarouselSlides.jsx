...
const websites = [
    ...
    { title: 'Pick a Pump', url: 'https://pickapump.com', image: pickapump, info: "Pick a Pump is a start-up app, this site is a business landing page to display different features and potential business opportunities, includes custom contact form and FAQs for potential clients and investors."},
                                    ...
                                    {websites.map((website, index) => (
                                        ...
                                        <div className='slide-row'>
                                          ...
                                          <div className="content-container">
                                              ...
                                              <p className="centered">{website.info}</p> <a className="links" href={website.url}><button type="button">Check It Out</button></a></div>
