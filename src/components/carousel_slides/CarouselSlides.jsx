...
import blankautophoto from '../../assets/blankautophoto.jpg'
...
const websites = [
    ...
    { title: 'Wizarding Words', url: 'https://wizardingwords.portkey.uk', image: wizardingwords, info: "Wizarding Words is a fun web wrapper written in React JS for a Harry Potter quote API I previously created."},
